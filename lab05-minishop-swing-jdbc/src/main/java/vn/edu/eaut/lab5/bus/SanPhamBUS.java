...
public class SanPhamBUS {
    ...
    public List<SanPham> searchAdvanced(String tenSp, BigDecimal giaTu, BigDecimal giaDen,
                                        Integer slTu, Integer slDen, int trang, int soDongMoiTrang) throws SQLException {
        int offset = (trang - 1) * soDongMoiTrang;
        return sanPhamDAL.searchAdvanced(tenSp, giaTu, giaDen, slTu, slDen, soDongMoiTrang, offset);
    }

    public int demTongSoDong(String tenSp, BigDecimal giaTu, BigDecimal giaDen,
                            Integer slTu, Integer slDen) throws SQLException {
        return sanPhamDAL.countAdvanced(tenSp, giaTu, giaDen, slTu, slDen);
    }
}